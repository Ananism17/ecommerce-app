...
class AppColors {
  ...
  static const Color darkBarColor = Color.fromARGB(255, 45, 24, 110); 
  static const Color darkPrimary = Color.fromARGB(255, 94, 75, 236);
  static const Color buroLogoOrange = Color.fromARGB(255, 243, 149, 36);
  static const Color buroLogoGreen = Color.fromARGB(255, 8,118,73);
}
